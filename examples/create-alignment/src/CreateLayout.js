...
async function CreateLayout(baseUrl, Mapi_Key, jsonInput) {
    //************************************************
    //CreateAlignments
    //************************************************
    ...
    const dbSKEW = await CreateSkew(baseUrl, Mapi_Key, Node_Start, Ti);
    const dbGRUP = await CreateGrup(
        baseUrl,
        Mapi_Key,
        Seg_Info[0],
        Seg_Info[8],
...
async function CreateNode(baseUrl, Mapi_Key, Node_Start, Xi, Yi) {
    //Json body
    let dbNODE = { Assign: {} };
...
async function CreateElem(
    ...
    //Web Request for Elements
    const res = await fetch(baseUrl + "/db/elem", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "MAPI-Key": Mapi_Key
...
async function CreateSkew(baseUrl, Mapi_Key, Node_Start, Ti) {
    //Json body
    let dbSKEW = { Assign: {} };
    ...
    //Web Request for Skew of nodes
    const res = await fetch(baseUrl + "/db/skew", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "MAPI-Key": Mapi_Key
...
async function CreateGrup(
    ...
    for (let i = 0; i < GroupName.length; i++) {
        ...
        var Nodei_list = new Array();
        var Nodej_list = new Array();
    ...
    //Web Request for Structure Group
    const res = await fetch(baseUrl + "/db/grup", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "MAPI-Key": Mapi_Key
